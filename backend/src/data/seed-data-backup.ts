...
export const seedAssets = [
  ...
  {
    id: 'asset-002',
    title: '上海国际赛车场F1赛事收益权（跟投）',
    description: `【跟投机会说明】
本项目为MIFC主基金投资溢出份额。项目总投资需求3250万元，主基金受单项目1000万限额限制，溢出2250万元开放跟投。

【项目介绍】
投资上海国际赛车场F1大奖赛及全年赛事运营收益权，享受门票销售、赛事承办费用及商业租赁的分成收益。场馆年均举办赛事超过50场，客流量稳定。

【投资亮点】
• 头部IP：F1中国大奖赛唯一举办地
• 稳定现金流：年均50+场赛事
• 多元收入：门票40% + 赛事承办35% + 商业租赁25%

【主基金参与】
MIFC主基金已投资1000万元（占比30.8%），与跟投投资人按比例分享收益。`,
    type: 'CO_INVESTMENT',
  ...
  // ========== 跟投项目 - 演唱会类 ==========
  {
    ...
    description: `【跟投机会说明】
本项目为MIFC主基金投资标的的跟投份额。主基金原计划投资1000万元（单项目限额），但考虑到项目优质且需求较大，项目方开放总计1500万元投资额度，溢出的500万元向合格投资人开放跟投。

【项目介绍】
周杰伦"嘉年华"世界巡回演唱会中国站（北京、上海、广州、成都）门票销售及周边商品收益权，预计观众总数超过40万人次。

【投资条款】
• 跟投额度：500万元（与主基金同等条款）
• 投资期限：8个月
• 预期收益：项目整体收益的18-28%
• 收益来源：门票销售75%、周边商品15%、赞助收入10%

【主基金参与】
MIFC主基金已投资1000万元（占项目总额66.7%），跟投投资人与主基金享有同等权益。`,
    type: 'CO_INVESTMENT',
    originalCategory: 'CONCERT_TICKET',
    targetAmount: 5000000,    // 跟投额度500万
    ...
    overflowFrom: {
      fundId: 'mifc-fund-lp-001',
      fundName: 'MIFC主基金LP份额 2024-Q1期',
      projectInvestLimit: 10000000,   // 主基金限额1000万
      projectTotalNeed: 15000000,     // 项目总需求1500万
      overflowAmount: 5000000,        // 溢出500万
    },
